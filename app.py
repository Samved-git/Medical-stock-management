...
def generate_chat_response(prompt):
    genai.configure()
    model_name = "models/gemini-1.5-turbo"  # Changed to supported Gemini model
    try:
...
# The rest of your app function implementations remain the same as before,
# including show_login_page(), show_ai_chatbot(), show_stock_management(),
# show_doctor_tracking(), show_dashboard(), etc. just replacing generate_chat_response with above.

# For brevity here is the chatbot function snippet fixed to work with new model:
